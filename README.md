...
> Badr Bouarafa et al. — submitted to *Computers in Biology and Medicine* (Elsevier), 2026.
...
│       └── V5_curves.png
├── paper/
│   ├── journal_mhcnn_cassc.tex   # Full journal paper (cas-sc, Elsevier)
│   └── journal_mhcnn_refs.bib    # BibTeX references (24 entries)
├── requirements.txt
├── environment.yml
└── README.md
```
...
> Update `note` with volume/pages/doi once accepted.
